$(function () {
    $("#jqGrid").jqGrid({
        ...
        data: vm.mydata,
        width: "100%",
        colNames:['序号', '污染物种类', '第一年','第二年','第三年','第一年','第二年','第三年','第一年','第二年','第三年','申请特殊时段许可排放量限值'],
        colModel: [
    ...
    $("#jqGrid").jqGrid('setGroupHeaders', {
        ...
        groupHeaders:[
            {startColumnName:'oe', numberOfColumns: 3, titleText: '年排放量限值(t/a)'},
            {startColumnName:'ue',numberOfColumns:3,titleText:'总量指标(t/a)'},
            {startColumnName:'total',numberOfColumns:3,titleText:'申请年排放量限值(t/a)'},
    ...
    methods: {
        ...
        saveOrUpdate: function (event) {
            let item = {
                ...
                ,total:vm.student.total,totalO:vm.student.totalO,totalT:vm.student.totalT,afseAmount:vm.student.afseAmount
            };
